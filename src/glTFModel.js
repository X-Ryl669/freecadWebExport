 ...
 */
{
    xeogl.GLTFModel = class xeoglGLTFModel extends xeogl.Model {
        ...
        init(cfg) {
            ...
            if ("src" in cfg) {
                this.src = cfg.src;
            } else if ("srcId" in cfg) {
                var json = document.getElementById(cfg.srcId).text;
                try {
                    ...
                    var model = this;
                    parseGLTF(gltf, this._options.basePath, this._options, model, function () {
                        spinner.processes--;
